...
describe('pooling layer: AveragePooling2D', function () {
  ...
  const testParams = [
    {
      inputShape: [6, 6, 3],
      attrs: { poolSize: [2, 2], strides: null, borderMode: 'valid', dimOrdering: 'tf' }
    },
    {
      inputShape: [6, 6, 3],
    ...
    {
      inputShape: [6, 6, 3],
      attrs: { poolSize: [3, 3], strides: null, borderMode: 'valid', dimOrdering: 'tf' }
    },
    {
      inputShape: [6, 6, 3],
    ...
    {
      inputShape: [6, 6, 3],
      attrs: { poolSize: [2, 2], strides: null, borderMode: 'same', dimOrdering: 'tf' }
    },
    {
      inputShape: [6, 6, 3],
    ...
    {
      inputShape: [6, 6, 3],
      attrs: { poolSize: [3, 3], strides: null, borderMode: 'same', dimOrdering: 'tf' }
    },
    {
      inputShape: [6, 6, 3],
    ...
    {
      inputShape: [4, 6, 4],
      attrs: { poolSize: [2, 2], strides: null, borderMode: 'valid', dimOrdering: 'th' }
    }
  ]

  before(function () {
    console.log('\n%cpooling layer: AveragePooling2D', styles.h1)
  })
  ...
  testParams.forEach(({ inputShape, attrs }, i) => {
    ...
    it(title, function () {
      console.log(`\n%c${title}`, styles.h3)
      let testLayer = new layers.AveragePooling2D(attrs)
