describe('core layer: Dense', function() {
  ...
  *********************************************************/
  describe('CPU', function() {
    ...
    it(
      '[core.Dense.1] [CPU] should produce expected values, with sigmoid activation function',
      function() {
        const key = 'core.Dense.1';
        console.log(
          `\n%c[${key}] [CPU] test 2 (with sigmoid activation)`,
          styles.h3
        );
        let testLayer = new layers.Dense({
          outputDim: 2,
          activation: 'sigmoid'
        });
        testLayer.setWeights(
    ...
    it(
      '[core.Dense.2] [CPU] should produce expected values, with softplus activation function and no bias',
      function() {
        const key = 'core.Dense.2';
        console.log(
          `\n%c[${key}] [CPU] test 3 (with softplus activation and no bias)`,
          styles.h3
        );
        let testLayer = new layers.Dense({
          outputDim: 2,
  ...
  *********************************************************/
  describe('GPU', function() {
    ...
    it(
      '[core.Dense.4] [GPU] should produce expected values, with sigmoid activation function',
      function() {
        const key = 'core.Dense.4';
        console.log(
          `\n%c[${key}] [GPU] test 2 (with sigmoid activation)`,
          styles.h3
        );
        let testLayer = new layers.Dense({
          outputDim: 2,
    ...
    it(
      '[core.Dense.5] [GPU] should produce expected values, with softplus activation function and no bias',
      function() {
        const key = 'core.Dense.5';
        console.log(
          `\n%c[${key}] [GPU] test 3 (with softplus activation and no bias)`,
          styles.h3
        );
        let testLayer = new layers.Dense({
          outputDim: 2,
