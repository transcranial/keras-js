describe('core layer: Merge', function() {
  ...
  *********************************************************/
  describe('sum', function() {
    ...
    it('[core.Merge.0] should produce expected values in sum mode', function() {
      ...
      let t1a = new KerasJS.Tensor(
        TEST_DATA[key].input.data,
        TEST_DATA[key].input.shape
      );
      let t1b = new KerasJS.Tensor(
        TEST_DATA[key].input.data,
        TEST_DATA[key].input.shape
      );
  ...
  *********************************************************/
  describe('concat', function() {
    ...
    it(
      '[core.Merge.4] should produce expected values in concat mode (1D)',
      function() {
        ...
        let ta = new KerasJS.Tensor(
          TEST_DATA[key].input.data,
          TEST_DATA[key].input.shape
        );
        let tb = new KerasJS.Tensor(
          TEST_DATA[key].input.data,
          TEST_DATA[key].input.shape
        );
    ...
    it(
      '[core.Merge.5] should produce expected values in concat mode (2D, concatAxis=-1)',
      function() {
    ...
    it(
      '[core.Merge.6] should produce expected values in concat mode (2D, concatAxis=-2)',
      function() {
    ...
    it(
      '[core.Merge.7] should produce expected values in concat mode (2D, concatAxis=1)',
      function() {
    ...
    it(
      '[core.Merge.8] should produce expected values in concat mode (2D, concatAxis=2)',
      function() {
  ...
  *********************************************************/
  describe('cos', function() {
    ...
    it(
      '[core.Merge.13] should produce expected values in cos mode (2D x 2D, dotAxes=(2,2))',
      function() {
        const key = 'core.Merge.12';
        console.log(
          `\n%c[${key}] mode: cos (2D x 2D, dotAxes=(2,2))`,
          styles.h3
        );
        let testLayer1a = new layers.Dense({ outputDim: 2 });
        let testLayer2a = new layers.RepeatVector({ n: 3 });
