describe('core layer: Activation', function() {
  ...
  it(
    '[core.Activation.0] should produce expected values for tanh activation following Dense layer',
    function() {
  ...
  it(
    '[core.Activation.1] should produce expected values for hardSigmoid activation following Dense layer',
    function() {
