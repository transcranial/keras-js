...
(function() {
  var DATA = {
    ...
    'activations.softmax.2': {
      ...
      expected: { data: [ 0, 0, 0, 0, 0, 1 ], shape: [ 6 ] }
    },
    ...
    'activations.softsign.0': {
      input: { data: [ 0, 0.2, 0.5, -0.1, 1, 2 ], shape: [ 6 ] },
      expected: { data: [ 0, 0.166667, 0.333333, -0.090909, 0.5, 0.666667 ], shape: [ 6 ] }
    },
    'activations.softsign.1': {
      input: { data: [ 0, 0.2, 0.5, -0.1, 1, 2, -0.03, 0.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 6 ] },
      expected: {
        data: [ 0, 0.166667, 0.333333, -0.090909, 0.5, 0.666667, -0.029126, 0.230769, 0, 0.444444, -0.230769, 0.5 ],
        shape: [ 2, 6 ]
      }
    },
    'activations.softsign.2': {
      input: { data: [ 0, 0.2, -0.5, -0.1, 1, 2, -0.03, 2.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 2, 3 ] },
      expected: {
        data: [ 0, 0.166667, -0.333333, -0.090909, 0.5, 0.666667, -0.029126, 0.69697, 0, 0.444444, -0.230769, 0.5 ],
        shape: [ 2, 2, 3 ]
      }
    },
    'activations.relu.0': {
      input: { data: [ 0, 0.2, 0.5, -0.1, 1, 2 ], shape: [ 6 ] },
      expected: { data: [ 0, 0.2, 0.5, 0, 1, 2 ], shape: [ 6 ] }
    },
    'activations.relu.1': {
      input: { data: [ 0, 0.2, 0.5, -0.1, 1, 2, -0.03, 0.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 6 ] },
      expected: { data: [ 0, 0.2, 0.5, 0, 1, 2, 0, 0.3, 0, 0.8, 0, 1 ], shape: [ 2, 6 ] }
    },
    'activations.relu.2': {
      input: { data: [ 0, 0.2, -0.5, -0.1, 1, 2, -0.03, 2.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 2, 3 ] },
      expected: { data: [ 0, 0.2, 0, 0, 1, 2, 0, 2.3, 0, 0.8, 0, 1 ], shape: [ 2, 2, 3 ] }
    },
    'activations.relu.3': {
      input: { data: [ 0, 0.2, -0.5, -0.1, 1, 2, -0.03, 2.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 2, 3 ] },
      expected: { data: [ 0, 0.2, 0, 0, 0.5, 0.5, 0, 0.5, 0, 0.5, 0, 0.5 ], shape: [ 2, 2, 3 ] }
    },
    'activations.relu.4': {
      input: { data: [ 0, 0.2, -0.5, -0.1, 1, 2, -0.03, 2.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 2, 3 ] },
      expected: { data: [ 0, 0.2, -0.15, -0.03, 1, 2, -0.009, 2.3, 0, 0.8, -0.09, 1 ], shape: [ 2, 2, 3 ] }
    },
    'activations.tanh.0': {
      input: { data: [ 0, 0.2, 0.5, -0.1, 1, 2 ], shape: [ 6 ] },
      expected: { data: [ 0, 0.197375, 0.462117, -0.099668, 0.761594, 0.964028 ], shape: [ 6 ] }
    },
    'activations.tanh.1': {
      input: { data: [ 0, 0.2, 0.5, -0.1, 1, 2, -0.03, 0.3, 0, 0.8, -0.3, 1 ], shape: [ 2, 6 ] },
      expected: {
