describe('merge layer: Add', function() {
  ...
  *********************************************************/
  describe('CPU', function() {
    ...
    it('[merge.Add.0] [CPU] should produce expected values', function() {
