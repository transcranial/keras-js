describe('merge layer: Subtract', function() {
  ...
  const testParams = [{ numBranches: 2, attrs: { units: 2 } }]
  ...
  describe('CPU', function() {
    ...
    testParams.forEach(({ numBranches, attrs }, i) => {
      ...
      it(title, function() {
        ...
        const mergeLayer = new layers.Subtract()
  ...
  describe('GPU', function() {
    ...
    testParams.forEach(({ numBranches, attrs }, i) => {
      ...
      it(title, function() {
        ...
        const mergeLayer = new layers.Subtract({ gpu: true })
        const startTime = performance.now()
        const output = mergeLayer.call(testInputs)
        const endTime = performance.now()
        console.log('%cout', styles.h4, stringifyCondensed(output.tensor))
