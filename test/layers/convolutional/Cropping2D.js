describe('convolutional layer: Cropping2D', function() {
  ...
  it(
    ...
    function() {
      ...
      console.log(
        `\n%c[${key}] cropping (1,1),(1, 1) on 3x5x4 input, dimOrdering=tf`,
        styles.h3
      );
      let testLayer = new layers.Cropping2D({
        cropping: [ [ 1, 1 ], [ 1, 1 ] ],
        dimOrdering: 'tf'
      });
  ...
  it(
    `[convolutional.Cropping2D.0] cropping (1,1),(1, 1) on 3x5x4 input, dim_ordering=th`,
    function() {
      const key = `convolutional.Cropping2D.1`;
      console.log(
        `\n%c[${key}] cropping (1,1),(1, 1) on 3x5x4 input, dimOrdering=th`,
        styles.h3
      );
      let testLayer = new layers.Cropping2D({
        cropping: [ [ 1, 1 ], [ 1, 1 ] ],
  ...
  it(
    ...
    function() {
      ...
      console.log(
        `\n%c[${key}] cropping (4,2),(3,1) on 8x7x6 input, dimOrdering=tf`,
        styles.h3
      );
      let testLayer = new layers.Cropping2D({
        cropping: [ [ 4, 2 ], [ 3, 1 ] ],
  ...
  it(
    `[convolutional.Cropping2D.2] cropping (4,2),(3,1) on 8x7x6 input, dim_ordering=th`,
    function() {
      const key = `convolutional.Cropping2D.3`;
      console.log(
        `\n%c[${key}] cropping (4,2),(3,1) on 8x7x6 input, dimOrdering=th`,
        styles.h3
      );
      let testLayer = new layers.Cropping2D({
        cropping: [ [ 4, 2 ], [ 3, 1 ] ],
