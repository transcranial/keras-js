describe('convolutional layer: Cropping3D', function() {
  ...
  it(
    ...
    function() {
      ...
      console.log(
        `\n%c[${key}] cropping ((1,1), (1,1), (1,1)) on 3x5x3x3 input, dim_ordering=tf`,
        styles.h3
      );
      let testLayer = new layers.Cropping3D({
  ...
  it(
    `[convolutional.Cropping3D.0] cropping ((1,1), (1,1), (1,1)) on 3x5x3x3 input, dim_ordering=th`,
    function() {
      const key = `convolutional.Cropping3D.1`;
      console.log(
        `\n%c[${key}] cropping ((1,1), (1,1), (1,1)) on 3x5x3x3 input, dim_ordering=th`,
        styles.h3
      );
      let testLayer = new layers.Cropping3D({
        cropping: [ [ 1, 1 ], [ 1, 1 ], [ 1, 1 ] ],
  ...
  it(
    ...
    function() {
      ...
      console.log(
        `\n%c[${key}] cropping (3,2), (2,1), (2,3)) on 7x6x6x6 input, dim_ordering=tf`,
        styles.h3
      );
      let testLayer = new layers.Cropping3D({
        cropping: [ [ 3, 2 ], [ 2, 1 ], [ 2, 3 ] ],
        dimOrdering: 'tf'
      });
      let t = new KerasJS.Tensor(
        TEST_DATA[key].input.data,
  ...
  it(
    `[convolutional.Cropping3D.2] cropping (3,2), (2,1), (2,3)) on 7x6x6x6 input, dim_ordering=th`,
    function() {
      const key = `convolutional.Cropping3D.3`;
      console.log(
        `\n%c[${key}] cropping (3,2), (2,1), (2,3)) on 7x6x6x6 input, dim_ordering=th`,
        styles.h3
      );
      let testLayer = new layers.Cropping3D({
        cropping: [ [ 3, 2 ], [ 2, 1 ], [ 2, 3 ] ],
