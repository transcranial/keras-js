describe('noise layer: GaussianDropout', function() {
  ...
  before(function() {
    console.log('\n%cnoise layer: GaussianDropout', styles.h1)
  })

  it('[noise.GaussianDropout.0] should just pass through tensor during test time', function() {
    const key = 'noise.GaussianDropout.0'
