describe('noise layer: GaussianNoise', function() {
  ...
  before(function() {
    console.log('\n%cnoise layer: GaussianNoise', styles.h1)
  })

  it('[noise.GaussianNoise.0] should just pass through tensor during test time', function() {
    const key = 'noise.GaussianNoise.0'
