describe('pipeline_15', function() {
  ...
  const testParams = {
    layers: [
      ...
      {
        layerClass: 'SeparableConv2D',
        attrs: { name: 'layer_3', filters: 2, kernel_size: 3, strides: 1, padding: 'same' },
        inbound: ['layer_2'],
        outbound: ['layer_4']
      },
      {
        layerClass: 'BatchNormalization',
        attrs: { name: 'layer_4', epsilon: 1e-3, axis: -1, center: true, scale: true },
        inbound: ['layer_3'],
        outbound: []
      }
    ]
